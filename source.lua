...
local prompt = useStudio and require(script.Parent.prompt) or loadWithTimeout(
...
if promptUser == 1 and prompt and type(prompt.create) == 'function' then
    prompt.create('Be cautious when running scripts', "Please be careful when running scripts from unknown developers. This script has already been ran.\r\n\r\n<font transparency='0.3'>Some scripts may steal your items or in-game goods.</font>", 'Okay', '', function(
    ) end)
end
if debugX then
...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout(
...
RayfieldLibrary.Notify = function(self, data)
    task.spawn(function()
...
RayfieldLibrary.CreateWindow = function(self, Settings)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
    ...
    Window.CreateTab = function(self, Name, Image, Ext)
        local SDone = false
        ...
        Tab.CreateButton = function(self, ButtonSettings)
            local ButtonValue = {}
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
            ...
            ButtonValue.Set = function(self, NewButton)
        ...
        Tab.CreateColorPicker = function(self, ColorPickerSettings)
...
-Main.MainPoint.AbsoluteSize.Y / 2)
            ...
            ColorPickerSettings.Set = function(self, RGBColor)
                ColorPickerSettings.Color = RGBColor
        ...
        Tab.CreateSection = function(self, SectionName)
            ...
            SectionValue.Set = function(self, NewSection)
        ...
        Tab.CreateDivider = function(self)
            local DividerValue = {}
            ...
            DividerValue.Set = function(self, Value)
                Divider.Visible = Value
            end

            return DividerValue
        end
        Tab.CreateLabel = function(self, LabelText, Icon, Color, IgnoreTheme)
            local LabelValue = {}
            ...
            LabelValue.Set = function(self, NewLabel, Icon, Color)
        ...
        Tab.CreateParagraph = function(self, ParagraphSettings)
            ...
            ParagraphValue.Set = function(self, NewParagraphSettings)
        ...
        Tab.CreateInput = function(self, InputSettings)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
            ...
            InputSettings.Set = function(self, text)
        ...
        Tab.CreateDropdown = function(self, DropdownSettings)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
            ...
            DropdownSettings.Set = function(self, NewOption)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
            ...
            DropdownSettings.Refresh = function(self, optionsTable)
        ...
        Tab.CreateKeybind = function(self, KeybindSettings)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
            ...
            KeybindSettings.Set = function(self, NewKeybind)
        ...
        Tab.CreateToggle = function(self, ToggleSettings)
            local ToggleValue = {}
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
            ...
            ToggleSettings.Set = function(self, NewToggleValue)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
        ...
        Tab.CreateSlider = function(self, SliderSettings)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
            ...
            SliderSettings.Set = function(self, NewVal)
...
[[Check docs.sirius.menu for help with Rayfield specific development.]])
    ...
    Window.ModifyTheme = function(NewTheme)
...
RayfieldLibrary.SetVisibility = function(self, visibility)
    setVisibility(visibility, false)
end
RayfieldLibrary.IsVisible = function(self)
    return not Hidden
end

local hideHotkeyConnection

RayfieldLibrary.Destroy = function(self)
...
RayfieldLibrary.LoadConfiguration = function(self)
    local config
